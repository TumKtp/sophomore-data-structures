...
void vector_swap(vector<int> &v1, vector<int> &v2,
                 ...
                 int start2, int end2)
{
    vector<int> v3(v1.begin() + start1, v1.begin() + end1);
    vector<int> v4(v2.begin() + start2, v2.begin() + end2);
    v1.erase(v1.begin() + start1, v1.begin() + end1);
    v2.erase(v2.begin() + start2, v2.begin() + end2);
    v1.insert(v1.begin() + start1, v4.begin(), v4.end());
    v2.insert(v2.begin() + start2, v3.begin(), v3.end());
}
int main()
{
    // read input
