...
bool test1()
{
  CP::vector<int> v(10);
  auto it = v.begin();
  if (!(v.valid_iterator(v.end()) == false))
    return false;
...
bool test4()
{
  ...
  auto it = v.begin() + 1;
  v.push_back(30);
  if (!(v.valid_iterator(v.end() - 1) == true))
    return false;
  return v.valid_iterator(it) == false;
}
...
bool test5()
{
  ...
  v.resize(3);
  auto it = v.begin() + 3;
  if (!(v.valid_iterator(v.begin()) == true))
    return false;
  return v.valid_iterator(it) == false;
}
...
bool test6()
{
  ...
  v.push_back(10);
  v.push_back(20);
  if (!(v.valid_iterator(v.begin() + 1) == true))
    return false;
  auto it = v.begin() + 1;
  v.pop_back();
  return v.valid_iterator(it) == false;
...
{
  CP::vector<int> v(11);
  if (!(v.valid_iterator(v.end() + 1) == false))
    return false;
  v.erase(v.begin() + 5);
  auto it = v.end();
...
bool test10()
{
  CP::vector<int> v(10);
  auto it = v.begin();
  if (!(v.valid_iterator(it + v.size()) == false))
    return false;
  v.erase(v.begin());
  return v.valid_iterator(it) == true;
}
